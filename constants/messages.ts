...
export const emails = {
	...
	account: {
		deleted: 'Your Expenso account is Deleted!',
	},
	welcome: {
	...
	from: 'Naruto from Expenso <wesocialteam@gmail.com>',
	signin: { subject: 'Sign in link for Expenso' },
	signup: { subject: 'Sign up link for Expenso' },
};
